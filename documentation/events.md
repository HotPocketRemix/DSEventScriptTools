...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Desired register state | B (%d) | ENUM_CONDITION_STATE | 1 | |
| Target Register | b (%d) | ENUM_REGISTER | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Comparison type | b (%d) | ENUM_COMPARISON_TYPE | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Desired Flag State | B (%d) | ENUM_ON_OFF_CHANGE | 1 | |
| Event flag type | B (%d) | ENUM_FLAG_TYPE | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Desired Flag State | B (%d) | ENUM_LOGICAL_OPERATION_TYPE | 0 | |
| Event flag type | B (%d) | ENUM_FLAG_TYPE | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Inside or outside? | B (%d) | ENUM_CONTAINED | 1 | Are we checking whether the object is inside or outside the volume? |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Inside or outside? | B (%d) | ENUM_CONTAINED | 1 | Are we checking whether the object is inside or outside the radius? |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Item type | B (%08d) | ENUM_ITEM_TYPE | 0 | |
| Item ID | i (%08d) | 0:1:100000000 | 0 | |
| Owned state | B (%d) | ENUM_OWN_STATE | 1 | Are we checking whether the PC has the item or not? |
...
| Reaction Attribute | B (%d) | ENUM_REACTION_ATTRIBUTE | 255 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Desired multiplayer status | b (%d) | ENUM_MULTIPLAYER_STATE | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Inside / Outside | B (%d) | ENUM_BOOL | 1 | Are we checking whether the object is inside or outside the area/block? |
...
| Start Event Flag ID | i (%08d) | 0:1:100000000 | 0 | |
| End Event Flag ID | i (%08d) | 0:1:100000000 | 0 | |
| Comparison type | b (%d) | ENUM_COMPARISON_TYPE | 4 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Tendency type | B (%d) | ENUM_TENDENCY_TYPE | 0 | |
| Comparison type | B (%d) | ENUM_COMPARISON_TYPE | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Item type | i (%08d) | ENUM_ITEM_TYPE | 0 | |
| Item ID | i (%08d) | 0:1:100000000 | 0 | |
...
| Item type | B (%08d) | ENUM_ITEM_TYPE | 0 | |
| Item ID | i (%08d) | 0:1:100000000 | 0 | |
| Owned state | B (%d) | ENUM_OWN_STATE | 1 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Owns DLC? | B (%d) | ENUM_BOOL | 1 | Are we checking if the PC does or doesn't own the DLC? |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Online state | B (%d) | ENUM_BOOL | 1 | Are we checking if the PC does or doesn't own the DLC? |
...
| Desired death status | B (%d) | ENUM_DEATH_STATUS | 1 | |
...
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Character Entity ID | i (%08d) | 0:1:1000000000 | 0 | |
| Character Type | b (%d) | ENUM_CHARACTER_TYPE | 0 | |
...
| Desired target presence | B (%d) | ENUM_BOOL | 1 | |
...
| Desired effect presence | B (%d) | ENUM_BOOL | 1 | |
...
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Character Entity ID | i (%08d) | 0:1:1000000000 | 0 | |
| AI State | B (%d) | ENUM_AI_STATUS_TYPE | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Desired lamp state? | B (%d) | ENUM_BOOL | 1 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Player Class Type | B (%d) | ENUM_CLASS_TYPE | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Player Covenant Type | B (%d) | ENUM_COVENANT_TYPE | 0 | |
...
|-|-|-|-|-|
| Result Register | b (%d) | ENUM_REGISTER | 0 | Where the result is stored |
| Desired object damage state | B (%d) | ENUM_DAMAGE_STATE | 1 | |
...
|-|-|-|-|-|
| Desired register state | B (%d) | ENUM_CONDITION_STATE | 1 | |
| Condition Register | b (%d) | ENUM_REGISTER | 0 | |
...
| Name | Type (Format) | Values | Default Value | Notes |
|-|-|-|-|-|
| Event end type | B (%d) | ENUM_EVENT_END_TYPE | 0 | |
| Desired register state | B (%d) | ENUM_CONDITION_STATE | 1 | |
| Condition Register | b (%d) | ENUM_REGISTER | 0 | |
...
|-|-|-|-|-|
| Lines to skip | B (%d) | 0:1:99 | 1 | |
| Desired Flag State | B (%d) | ENUM_ON_OFF | 1 | |
| Event flag type | B (%d) | ENUM_FLAG_TYPE | 0 | |
| Event flag ID | i (%08d) | 0:1:100000000 | 0 | |
...
| Name | Type (Format) | Values | Default Value | Notes |
|-|-|-|-|-|
| Is enabled | B (%d) | ENUM_ENABLE_STATE | 0 | |
...
| Playback method | I (%d) | ENUM_CUTSCENE_TYPE | 0 | |
...
| Loop? | B (%d) | ENUM_BOOL | 0 | |
| Wait for completion? | B (%d) | ENUM_BOOL | 0 | |
...
| Desired state | B (%d) | ENUM_ON_OFF | 1 | |
...
| Event end type | B (%d) | ENUM_EVENT_END_TYPE | 1 | |
...
| Name | Type (Format) | Values | Default Value | Notes |
|-|-|-|-|-|
| Is Enabled | h (%d) | ENUM_ENABLE_STATE | 0 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Navimesh Collision Bit | I (%d) | ENUM_NAVIMESH_TYPE | 128 | |
| Modification Type | B (%d) | ENUM_BITOP | 1 | |
...
| Loop? | B (%d) | ENUM_BOOL | 0 | |
| Wait for completion? | B (%d) | ENUM_BOOL | 0 | |
| Does not wait for transition | B (%d) | ENUM_BOOL | 0 | |
...
| Name | Type (Format) | Values | Default Value | Notes |
|-|-|-|-|-|
| Item type | i (%d) | ENUM_ITEM_TYPE | 1 | |
...
| Name | Type (Format) | Values | Default Value | Notes |
|-|-|-|-|-|
| Sign Type | i (%d) | ENUM_SIGN_TYPE | 0 | |
...
| Is visible | B (%d) | ENUM_ENABLE_STATE | 0 | |
...
| Name | Type (Format) | Values | Default Value | Notes |
|-|-|-|-|-|
| *Trend Type?* | B (%d) | ENUM_TENDENCY_TYPE | 0 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Team Type | B (%d) | ENUM_TEAM_TYPE | 0 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Warp Destination Type | B (%d) | ENUM_CATEGORY | 0 | |
...
| Part Index | h (%d) | ENUM_SITE_TYPE | 1 | |
...
| Is Invincible | B (%d) | ENUM_BOOL | 0 | |
| Start in stop state? | B (%d) | ENUM_BOOL | 0 | |
...
| Overwrite Max HP? | B (%d) | ENUM_BOOL | 0 | |
...
| Switch type | B (%d) | ENUM_ON_OFF_CHANGE | 1 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Authority Level | i (%d) | ENUM_UPDATE_AUTH | 0 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Should be Removed? | B (%d) | ENUM_BOOL | 1 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Disable Collision? | B (%d) | ENUM_BOOL | 1 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Fixed Frequency? | B (%d) | ENUM_BOOL | 1 | |
| Frequency | b (%d) | ENUM_CHARACTER_UPDATE_RATE | 0 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Interpolation Method | B (%d) | ENUM_INTERPOLATION_STATE | 0 | |
...
|-|-|-|-|-|
| Target Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Activated? | B (%d) | ENUM_ENABLE_STATE | 0 | |
...
| Behavior ID | i (%d) | 0:1:1000000000 | 0 | |
| Target type | i (%d) | ENUM_DAMAGE_TARGET_TYPE | 1 | |
...
| Area ID | B (%d) | 0:1:99 | 0 | |
| Block ID | B (%d) | 0:1:99 | 0 | |
| Statue type | B (%d) | ENUM_STATUE_TYPE | 0 | |
...
|-|-|-|-|-|
| Target Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Invulnerable? | B (%d) | ENUM_ENABLE_STATE | 0 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Should Erase only root | B (%d) | ENUM_BOOL | 1 | |
...
| Button Type | h (%d) | ENUM_BUTTON_TYPE | 0 | |
| Number of Buttons | h (%d) | ENUM_BUTTON_NUMBER | 6 | |
...
| Name | Type (Format) | Values | Default Value | Notes |
|-|-|-|-|-|
| Banner Type | B (%d) | ENUM_TEXT_BANNER_TYPE | 8 | |
...
|-|-|-|-|-|
| Message ID | i (%d) | 0:1:1000000000 | 0 | |
| Pad Enabled? | B (%d) | ENUM_ENABLE_STATE | 0 | |
...
| Name | Type (Format) | Values | Default Value | Notes |
|-|-|-|-|-|
| Playback settings | B (%d) | ENUM_ON_OFF | 0 | Param name could be 'Enabled' |
| SlotNo | H (%.d) | 0:1:20 | 0 | |
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Sound Type | i (%d) | ENUM_SOUND_TYPE | 0 | |
...
|-|-|-|-|-|
| Entity ID | i (%d) | 0:1:1000000000 | 0 | |
| Enalbled | B (%d) | ENUM_ENABLE_STATE | 0 | |
